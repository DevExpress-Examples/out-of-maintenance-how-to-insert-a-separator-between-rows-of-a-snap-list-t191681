...
Namespace SnapSeparatorExample
    Partial Public Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            ds.Tables.Add(dt)
            Me.snapControl1.DataSources.Add("DS", ds)

            ' Create a Snap list and populate it with the data.
            Dim snList As SnapList = Me.snapControl1.Document.CreateSnList(Me.snapControl1.Document.Range.Start, "List1")
            snList.BeginUpdate()
            ...
            snList.Separator.AppendText(New String(ControlChars.FormFeed, 1))
